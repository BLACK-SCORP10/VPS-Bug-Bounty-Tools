# Note: This Code was Made By drak3hft7 | I am Just Maintaining the CODE!
...
# Update - Time Line: 
- 31 August 2024: Added Latest Go tools and removed depreciated `go get` to `go install` with $PATH
- Old Time Line
...
# Please Create a Issue if you want to add or remove any tools. Dont forget to fork this repo!! 

Want To Connect with Me! : 
Email: mailto:sayedalirizvi001@gmail.com 
Linkedin: [alisayed001](https://www.linkedin.com/in/alisayed001/)
