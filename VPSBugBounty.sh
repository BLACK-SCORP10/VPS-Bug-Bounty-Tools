...
cd /tmp && wget https://go.dev/dl/go1.23.0.linux-amd64.tar.gz > /dev/null 2>&1 && tar xvf go1.23.0.linux-amd64.tar.gz > /dev/null 2>&1;
mv go /usr/local
...
go install -u github.com/gwen001/github-subdomains@latest > /dev/null 2>&1 && ln -s ~/go/bin/github-subdomains /usr/local/bin/;
...
go install -u github.com/tomnomnom/assetfinder@latest > /dev/null 2>&1 && ln -s ~/go/bin/assetfinder /usr/local/bin/;
...
go install -u github.com/ffuf/ffuf/v2@latest > /dev/null 2>&1 && ln -s ~/go/bin/ffuf /usr/local/bin/;
...
go install -u github.com/ferreiraklet/Jeeves@latest > /dev/null 2>&1 && ln -s ~/go/bin/jeeves /usr/local/bin/;
cd ~/tools/
...
go install -u github.com/dwisiswant0/unew@latest > /dev/null 2>&1 && ln -s ~/go/bin/unew /usr/local/bin/;
echo -e "\e[32mDone! Dnsgen installed."; echo "";
sleep 1.5
#gf
echo -e "\e[93m\e[1m----> Installing gf";
go install -u github.com/tomnomnom/gf@latest > /dev/null 2>&1 && ln -s ~/go/bin/gf /usr/local/bin/;
